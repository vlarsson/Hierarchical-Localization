...
from hloc.utils.read_line_model import read_line_model

parser = argparse.ArgumentParser()
parser.add_argument('--dataset', type=Path, default='../../datasets/aachen_undist/undistorted',
                    help='Path to the dataset, default: %(default)s')
parser.add_argument('--outputs', type=Path, default='/home/vlarsson/work/hloc_new/outputs/aachen_v1.1',
...
line_rec_path = '../../datasets/aachen_undist/limap/'
...
line_rec = read_line_model('../../datasets/aachen_undist/limap')
q_line_rec = read_line_model('../../datasets/aachen_undist/limap','query_')


localize_sfm.main(
    reference_sfm,
    dataset / '*_undistorted.txt',
    loc_pairs,
    features,
    loc_matches,
    results,
    covisibility_clustering=False,  # not required with SuperPoint+SuperGlue
    reference_lines=line_rec,
    query_lines=q_line_rec)
